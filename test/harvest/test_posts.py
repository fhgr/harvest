...
def test_extract_posts_forum_angelman(load_test_data):
    ...
    assert post['url_xpath_pattern'] == '//html/body/div/a'
    assert post['date_xpath_pattern'] == \
           '//div[@class="message-body"]/..//div[@class="generic"]/table/tr/td/small/br'
...
def test_extract_posts_forum_maladiesraresinfo(load_test_data):
    ...
    assert post['url_xpath_pattern'] == '//a[@class="top"]'
    assert post['date_xpath_pattern'] == \
           '//div[@class="content"]/../..//p[@class="author"]/strong'
    assert post['user_xpath_pattern'] == \
...
def test_extract_posts_forum_shift_ms(load_test_data):
    ...
    assert post['url_xpath_pattern'] == '//a[@class="bbp-author-avatar"]'
    assert post['date_xpath_pattern'] == '//div[@class="bbp-reply-content"]/p/../../..//div[@class="bbp-reply-date"]'
    assert post['user_xpath_pattern'] == \
...
def test_extract_posts_forum_healingwell(load_test_data):
    ...
    assert post['url_xpath_pattern'] == '//div[@class="post-even"]/a'
    assert post['date_xpath_pattern'] == '//div[@class="post-body"]/../../..//div[@class="posts"]'
    assert post['user_xpath_pattern'] == \
